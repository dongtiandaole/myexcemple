...
import com.excel.loadText;
import com.media.medias;
...
public class mediaCreat {
    ...
    public void test() throws IOException {
        ...
        WriteExcel.creatExcel(dmEntities);
    }
                ...
                for (int j = 0; j < count; j++) {
                    ...
                    if (fList[j].isDirectory()) {//判断当前对象是否是目录
                        ...
                        if(".svg".equals(suffix)){
                            ...
                            String dmCode = "DMC-AA-A-"+sns.substring(0,2)+"-"+sns.substring(2,6)+"-"+sns.substring(6,8)+"-"+sns.substring(8,12)+"A-943"+ com.media.loadText.numberToLetter(sums)+"-D_000-00_zh-CN";
...
//                            CopyFile.copy(pdfPath, newPath,rename);
                            path2+=".txt";
                            if(path2.indexOf("D:\\EMBS12_002\\routes\\queryparts\\file\\SML12EXP\\11设计资料和图纸")!=-1){
                                com.excel.loadText.traverseFolder(path2,sns,names,rename);
                            }
