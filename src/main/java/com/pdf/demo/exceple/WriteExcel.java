...
public class WriteExcel {
    public static void creatExcel( List<pdfs> pdfsList) {
        ...
        try {
            FileOutputStream out = new FileOutputStream("C:\\Users\\Administrator\\Desktop\\atta.xls");
